...
const OpenerSection = ({ onOpen }: { onOpen: () => void }) => {
    ...
    return (
        <div className="flex flex-col min-h-dvh justify-between chivo-font z-50 lg bg-[#ECDCCB] transition-opacity duration-500 ease-in-out relative overflow-y-auto">
            <Image
                src={`/flower-1.svg`}
                width={0}
                height={0}
            ...
            <div className="m-1 md:m-4 z-50 sticky">
                <button
                    onClick={handleOpen}
